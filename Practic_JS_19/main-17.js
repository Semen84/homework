...
let number = 7; // Можно изменить значение для проверки других чисел
if (number % 2 === 0) {
...
let age = 166; // Можно изменить значение для проверки других возрастов
...
let deliveryType = prompt("Введите тип доставки");
let baseCost = 0;
...
alert("Итоговая стоимость доставки: " + baseCost + " ₽.");
